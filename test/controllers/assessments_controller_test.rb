...
class AssessmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assessment" do
    assert_difference('Assessment.count') do
      post assessments_url, params: { assessment: { test1: @assessment.test1, test2: @assessment.test2, test3: @assessment.test3 } }
    end
  ...
  test "should update assessment" do
    patch assessment_url(@assessment), params: { assessment: { test1: @assessment.test1, test2: @assessment.test2, test3: @assessment.test3 } }
